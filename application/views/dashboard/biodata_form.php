...
<?php echo form_open($form_action, array('id'=>'myform', 'class'=>'form-horizontal', 'role'=>'form')) ?>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-sm-2">
            <p class="form-control-static"><?php echo format_no_peserta($values->id);?></p>
        </div>
    </div>
    ...
    <!-- ska_tahun_lulus -->
    <div class="form-group form-group-sm has-feedback <?php set_validation_style('ska_tahun_lulus')?>">        
        <?php echo form_label('Tahun Lulus', 'ska_tahun_lulus', array('class' => 'control-label col-sm-3')) ?>
        <div class="col-sm-2">
            <div class="input-group date" data-date-format="yyyy">                
                <?php echo form_input('ska_tahun_lulus', $values->ska_tahun_lulus, 'id="ska_tahun_lulus" class="form-control" placeholder="Tahun Lulus" maxlength="4"') ?>
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
            </div>
        </div>
        <?php if (form_error('ska_tahun_lulus')) : ?>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('ska_tahun_lulus', '<span class="help-block">', '</span>');?>
            </div>
        <?php endif ?>
    </div>
    ...
    <h3 class="bg-success">E. Nilai</h3>
    ...
    <div class="form-group form-group-sm has-feedback <?php set_validation_style(array('nil_big_1', 'nil_big_2', 'nil_big_3', 'nil_big_4', 'nil_big_5'))?>">
        <label for="nil_big_1" class="col-sm-3 control-label">Bahasa Inggris</label>
        <div class="col-sm-1">
            <?php echo form_input('nil_big_1', $values->nil_big_1, 'id="nil_big_1" class="form-control" placeholder="Big 1" maxlength="3"') ?>            
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_big_2', $values->nil_big_2, 'id="nil_big_2" class="form-control" placeholder="Big 2" maxlength="3"') ?>            
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_big_3', $values->nil_big_3, 'id="nil_big_3" class="form-control" placeholder="Big 3" maxlength="3"') ?>            
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_big_4', $values->nil_big_4, 'id="nil_big_4" class="form-control" placeholder="Big 4" maxlength="3"') ?>            
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_big_5', $values->nil_big_5, 'id="nil_big_5" class="form-control" placeholder="Big 5" maxlength="3"') ?>            
        </div>

        <!-- Form validation error Bahasa Inggris -->
        <?php if (form_error('nil_big_1') || form_error('nil_big_2') || form_error('nil_big_3') || form_error('nil_big_4') || form_error('nil_big_5')) : ?>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_big_1', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_big_2', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_big_3', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_big_4', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_big_5', '<span class="help-block">', '</span>');?>
            </div>
        <?php endif ?>
    </div>
    ...
    <div class="form-group form-group-sm has-feedback <?php set_validation_style(array('nil_mat_1', 'nil_mat_2', 'nil_mat_3', 'nil_mat_4', 'nil_mat_5'))?>">
        <label for="nil_big_1" class="col-sm-3 control-label">Matematika</label>
        <div class="col-sm-1">
    ...
    <!-- Nilai IPA -->
    <div class="form-group form-group-sm has-feedback <?php set_validation_style(array('nil_ipa_1', 'nil_ipa_2', 'nil_ipa_3', 'nil_ipa_4', 'nil_ipa_5'))?>">
        <label for="nil_big_1" class="col-sm-3 control-label">IPA</label>
        <div class="col-sm-1">
            <?php echo form_input('nil_ipa_1', $values->nil_ipa_1, 'id="nil_ipa_1" class="form-control" placeholder="IPA 1" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ipa_2', $values->nil_ipa_2, 'id="nil_ipa_2" class="form-control" placeholder="IPA 2" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ipa_3', $values->nil_ipa_3, 'id="nil_ipa_3" class="form-control" placeholder="IPA 3" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ipa_4', $values->nil_ipa_4, 'id="nil_ipa_4" class="form-control" placeholder="IPA 4" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ipa_5', $values->nil_ipa_5, 'id="nil_ipa_5" class="form-control" placeholder="IPA 5" maxlength="3"') ?>
        </div>

        <!-- Form validation error IPA -->
        <?php if (form_error('nil_ipa_1') || form_error('nil_ipa_2') || form_error('nil_ipa_3') || form_error('nil_ipa_4') || form_error('nil_ipa_5')) : ?>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ipa_1', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ipa_2', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ipa_3', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ipa_4', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ipa_5', '<span class="help-block">', '</span>');?>
            </div>
        <?php endif ?>
    </div> <!-- Nilai IPA end -->

    <!-- Nilai IPS -->
    <div class="form-group form-group-sm has-feedback <?php set_validation_style(array('nil_ips_1', 'nil_ips_2', 'nil_ips_3', 'nil_ips_4', 'nil_ips_5'))?>">
        <label for="nil_big_1" class="col-sm-3 control-label">IPS</label>
        <div class="col-sm-1">
            <?php echo form_input('nil_ips_1', $values->nil_ips_1, 'id="nil_ips_1" class="form-control" placeholder="IPS 1" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ips_2', $values->nil_ips_2, 'id="nil_ips_2" class="form-control" placeholder="IPS 2" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ips_3', $values->nil_ips_3, 'id="nil_ips_3" class="form-control" placeholder="IPS 3" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ips_4', $values->nil_ips_4, 'id="nil_ips_4" class="form-control" placeholder="IPS 4" maxlength="3"') ?>
        </div>
        <div class="col-sm-1">
            <?php echo form_input('nil_ips_5', $values->nil_ips_5, 'id="nil_ips_5" class="form-control" placeholder="IPS 5" maxlength="3"') ?>
        </div>

        <!-- Form validation error IPS -->
        <?php if (form_error('nil_ips_1') || form_error('nil_ips_2') || form_error('nil_ips_3') || form_error('nil_ips_4') || form_error('nil_ips_5')) : ?>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ips_1', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ips_2', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ips_3', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ips_4', '<span class="help-block">', '</span>');?>
            </div>
            <div class="col-sm-9 col-sm-offset-3">
                <?php echo form_error('nil_ips_5', '<span class="help-block">', '</span>');?>
            </div>
        <?php endif ?>
    </div>
